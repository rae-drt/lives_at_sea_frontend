      ...
      <CardContent>
        <Stack direction='row' justifyContent='space-between' spacing={2}>
          ...
          <Stack direction='row' spacing={2}>
            <FormControlLabel control={<Checkbox data-testid='errorToggle' data-value={data.error} checked={data?.error} disabled={true}/>} label='Error?' labelPlacement='start'/>
            <Button data-testid='personCommitButton' disabled={(!dirty) || loading || locked} variant='outlined' onClick={onChange}>Enter</Button>
