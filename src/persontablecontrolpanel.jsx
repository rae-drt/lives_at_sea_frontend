      ...
      <CardContent>
        <Stack direction='row' justifyContent='space-between' spacing={2}>
          ...
          <Stack direction='row' spacing={2}>
            {'error' in data && <FormControlLabel control={<Checkbox checked={data.error} disabled={true} data-testid='error' data-value={data.error}/>} label='Error?' labelPlacement='start'/>}
